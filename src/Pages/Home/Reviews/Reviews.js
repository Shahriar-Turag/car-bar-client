...
const Reviews = () => {
    ...
    useEffect(() => {
        setLoading(true);
        fetch("https://hidden-forest-40696.herokuapp.com/reviews")
            .then((res) => res.json())
            .then((data) => {
                setReviews(data);
                setLoading(false);
    ...
    return (
        <div
            className="container home-reviews text-center"
            style={{ paddingTop: "150px" }}
        >
            <h2 className="fw-bold">
                Client's <span className="text-warning">Review</span>
            </h2>
                          ...
                          .map((review) => (
                              <div className="col" key={review._id}>
                                  <div className="card single-agent h-100 p-3 p-lg-4 rounded mx-lg-2">
                                      <div className="card-body d-flex flex-column justify-content-between pt-3 px-0">
                                          <div>
